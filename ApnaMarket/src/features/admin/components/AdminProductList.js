                              ...
                              <div>
                                ...
                                <div className="mt-4 inline">
                                  <Link
                                    ...
                                    className="rounded-md bg-[#686666] px-3 py-1 text-sm font-semibold text-white shadow-sm hover:bg-[rgb(170,167,167)]  "
                                  >
                                    Edit
                                  </Link>
                                </div>
                                <div className="inline">
                                  {product.deleted && (
                                    <p className="text-sm text-red-600 inline ml-5">
                                      Product deleted
                                    </p>
                                  )}
                                </div>
